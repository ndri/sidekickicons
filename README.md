...
| ![arrows-crossing.svg](src/24/outline/arrows-crossing.svg)           | ![arrows-crossing.svg](src/24/solid/arrows-crossing.svg)           | ![arrows-crossing.svg](src/20/solid/arrows-crossing.svg)           | ![arrows-crossing.svg](src/16/solid/arrows-crossing.svg)           | arrows-crossing      | ArrowsCrossingIcon    | shuffle, random                  |
| ![badge.svg](src/24/outline/badge.svg)                               | ![badge.svg](src/24/solid/badge.svg)                               | ![badge.svg](src/20/solid/badge.svg)                               | ![badge.svg](src/16/solid/badge.svg)                               | badge                | BadgeIcon             | shape                            |
| ![bars-3-bottom-center.svg](src/24/outline/bars-3-bottom-center.svg) | ![bars-3-bottom-center.svg](src/24/solid/bars-3-bottom-center.svg) | ![bars-3-bottom-center.svg](src/20/solid/bars-3-bottom-center.svg) | ![bars-3-bottom-center.svg](src/16/solid/bars-3-bottom-center.svg) | bars-3-bottom-center | Bars3BottomCenterIcon | text, align, justify, center     |
...
| ![checklist-boxes.svg](src/24/outline/checklist-boxes.svg)           | ![checklist-boxes.svg](src/24/solid/checklist-boxes.svg)           | ![checklist-boxes.svg](src/20/solid/checklist-boxes.svg)           | ![checklist-boxes.svg](src/16/solid/checklist-boxes.svg)           | checklist-boxes      | ChecklistBoxesIcon    | todo, tasks                      |
| ![check-double.svg](src/24/outline/check-double.svg)                 | ![check-double.svg](src/24/solid/check-double.svg)                 | ![check-double.svg](src/20/solid/check-double.svg)                 | ![check-double.svg](src/16/solid/check-double.svg)                 | check-double         | CheckDoubleIcon       | read receipt, received           |
...
| ![circle.svg](src/24/outline/circle.svg)                             | ![circle.svg](src/24/solid/circle.svg)                             | ![circle.svg](src/20/solid/circle.svg)                             | ![circle.svg](src/16/solid/circle.svg)                             | circle               | CircleIcon            | shape                            |
...
| ![dice.svg](src/24/outline/dice.svg)                                 | ![dice.svg](src/24/solid/dice.svg)                                 | ![dice.svg](src/20/solid/dice.svg)                                 | ![dice.svg](src/16/solid/dice.svg)                                 | dice                 | DiceIcon              | random, roll                     |
...
| ![gamepad.svg](src/24/outline/gamepad.svg)                           | ![gamepad.svg](src/24/solid/gamepad.svg)                           | ![gamepad.svg](src/20/solid/gamepad.svg)                           | ![gamepad.svg](src/16/solid/gamepad.svg)                           | gamepad              | GamepadIcon           | play, controller                 |
...
| ![lettered-list.svg](src/24/outline/lettered-list.svg)               | ![lettered-list.svg](src/24/solid/lettered-list.svg)               | ![lettered-list.svg](src/20/solid/lettered-list.svg)               | ![lettered-list.svg](src/16/solid/lettered-list.svg)               | lettered-list        | LetteredListIcon      | ordered list                     |
...
| ![password.svg](src/24/outline/password.svg)                         | ![password.svg](src/24/solid/password.svg)                         | ![password.svg](src/20/solid/password.svg)                         | ![password.svg](src/16/solid/password.svg)                         | password             | PasswordIcon          | security, login                  |
| ![password-pencil.svg](src/24/outline/password-pencil.svg)           | ![password-pencil.svg](src/24/solid/password-pencil.svg)           | ![password-pencil.svg](src/20/solid/password-pencil.svg)           | ![password-pencil.svg](src/16/solid/password-pencil.svg)           | password-pencil      | PasswordPencilIcon    | edit, fill                       |
| ![photo-plus.svg](src/24/outline/photo-plus.svg)                     | ![photo-plus.svg](src/24/solid/photo-plus.svg)                     | ![photo-plus.svg](src/20/solid/photo-plus.svg)                     | ![photo-plus.svg](src/16/solid/photo-plus.svg)                     | photo-plus           | PhotoPlusIcon         | attach, upload                   |
| ![pilcrow.svg](src/24/outline/pilcrow.svg)                           | ![pilcrow.svg](src/24/solid/pilcrow.svg)                           | ![pilcrow.svg](src/20/solid/pilcrow.svg)                           | ![pilcrow.svg](src/16/solid/pilcrow.svg)                           | pilcrow              | PilcrowIcon           | paragraph, formatting            |
...
| ![square.svg](src/24/outline/square.svg)                             | ![square.svg](src/24/solid/square.svg)                             | ![square.svg](src/20/solid/square.svg)                             | ![square.svg](src/16/solid/square.svg)                             | square               | SquareIcon            | shape                            |
| ![triangle.svg](src/24/outline/triangle.svg)                         | ![triangle.svg](src/24/solid/triangle.svg)                         | ![triangle.svg](src/20/solid/triangle.svg)                         | ![triangle.svg](src/16/solid/triangle.svg)                         | triangle             | TriangleIcon          | shape                            |
